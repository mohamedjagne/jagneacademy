...
<template>
    <div
        class="md:w-1/4 w-full md:h-screen text-gray-900 border-r border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
    >
        <Link
            :href="route('student.account')"
            :class="{
                'bg-teal-100 text-teal-400': $page.url == '/student/account',
            }"
