    ...
    <div class="border-b border-gray-200 dark:border-gray-700">
        ...
        >
            <li class="mr-2">
                <a
                    href="#"
                    class="inline-flex items-center justify-center p-4 text-teal-400 border-b-2 border-teal-500 rounded-t-lg active dark:text-teal-300 dark:border-teal-400 group"
                >
                    <svg
