...
const thumbnailUrl = ref("/storage/" + props.course.thumbnail);
const previewUrl = ref("/storage/" + props.course.preview);
...
const submit = () => {
    router.post(route("courses.update", props.course.id), {
        _method: "put",
        title: form.title,
            ...
            <div>
                ...
                <div class="mt-4 md:flex md:space-x-2">
                    ...
                    <div>
                        ...
                        <div class="w-full bg-grey-lighter mt-2">
                            <label
                                v-if="!form.thumbnail"
                                class="w-72 h-44 flex flex-col items-center justify-center px-4 py-6 bg-white text-teal-400 rounded-lg shadow-sm tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue hover:text-teal-500"
                            >
                                <svg
                                    class="w-8 h-8"
                                    fill="currentColor"
                ...
                <div class="mt-4">
                    ...
                    <textarea
                        ...
                        id="objectives"
                        class="mt-2 border-teal-300 focus:border-teal-300 focus:ring-teal-400 rounded-md shadow-sm text-sm w-full"
                        placeholder="ex. overview of photoshop,mastering ai photoshop"
                    ></textarea>
                    <InputError :message="errors.objectives" />
                </div>
            </div>
            <PrimaryButton class="mt-4"> Update Course </PrimaryButton>
        </form>
    </AuthenticatedLayout>
</template>
